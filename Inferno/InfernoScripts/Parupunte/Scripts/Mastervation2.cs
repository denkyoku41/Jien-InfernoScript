...
{
    [ParupunteConfigAttribute("072（吸収）", "　やりますねぇ！　")]
    [ParupunteIsono("ナナニ")]
    //[ParupunteDebug(true)]
    internal class Mastervation2 : ParupunteScript
    {
        ...
        public Mastervation2(ParupunteCore core, ParupunteConfigElement element) : base(core, element)
        {
            SetUpSound();
        }
        ...
        public override void OnStart()
        {
            ...
            var animDict = "missbigscore1switch_trevor_piss";
        ...
        private void SetUpSound()
        {
            ...
            var setupWav = filePaths.FirstOrDefault(x => x.Contains("Mastervation.wav"));
            if (setupWav != null)
            {
