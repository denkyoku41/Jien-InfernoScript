...
{
    [ParupunteConfigAttribute("072（直球）", "　やりますねぇ！　")]
    [ParupunteIsono("ななに")]
    //[ParupunteDebug(true)]
    internal class Mastervation : ParupunteScript
    {
        ...
        public Mastervation(ParupunteCore core, ParupunteConfigElement element) : base(core, element)
        {
            SetUpSound();
        }
