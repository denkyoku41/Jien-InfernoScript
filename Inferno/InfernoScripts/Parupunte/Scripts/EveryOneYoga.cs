...
{
    [ParupunteConfigAttribute("市民全員同時ヨガ", "　おわり　")]
    [ParupunteIsono("みんなよが")]
    [ParupunteDebug(true)]
    internal class EveryoneYoga : ParupunteScript
    {
        ...
        public EveryoneYoga(ParupunteCore core, ParupunteConfigElement element) : base(core, element)
        {
            SetUpSound();
        }
