...
{
    [ParupunteConfigAttribute("ctOS 復旧", "")]
    [ParupunteIsono("つうでん")]
    //[ParupunteDebug(true)]
    class BlackOutFix : ParupunteScript
    {
        ...
        public BlackOutFix(ParupunteCore core, ParupunteConfigElement element) : base(core, element)
        {
            SetUpSound();
        }
