...
namespace Inferno.InfernoScripts.Parupunte.Scripts
{
    [ParupunteIsono("さーばる")]
   // [ParupunteDebug(true)]
    internal class Serval : ParupunteScript
    {
        private Model pedModel;
        private string name;
        private Random random;

        public Serval(ParupunteCore core, ParupunteConfigElement element) : base(core, element)
        {
        }
        ...
        public override void OnSetUp()
        {
            ...
            {
                case 0:
                    pedModel = new Model(PedHash.Trevor);
                    name = "サーバル召喚";
                    break;
